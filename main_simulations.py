...
model.fit(E, L, D, samples=1500, burn=500, random_seed = 37, debugHack=False)
...
#%%
# function to plot proportions of allocations (and show MF vs FM)
...
# plot weights of younger men vs older men
...
E, L, D = simulateLatentPoissonHGMM(N, Settings2)  
...
#%%
model2 = LatentPoissonDPHGMM(Priors = Pr, K=3, Kmax = 10)

model2.fit(E, L, D, samples=1500, burn=500, random_seed = 73, debugHack=False)

model2.plotChains('N_MF')
model2.plotChains('N_FM')
#model2.plotChains('muD')
#model2.plotChains('muNegD')
model2.plotChains('weightMF')
#model2.plotChains('weightFM')
#model2.plotChains('weight0')
#model.plotChains('muL')
#model.plotChains('gammaD')
#model.plotChains('gammaL')
...
model2.plotChains('C', s=1000)

#model.plotChains('componentsMF', s=1000)

# plot the components at MAP
model2.plotChains('componentsMF', s=np.argmax(model.chains['loglik']))
model2.plotChains('componentsFM', s=np.argmax(model.chains['loglik']))         

#%%
# plot stuff

plotProps(model2.chains['C'][500:], savepath='props_MFFM_unequal.pdf')

plotWeights(model2.chains['weightMF'], oldInd=1, savepath='younger_older_men_more_young.pdf')